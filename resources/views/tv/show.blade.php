...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $tvShow['poster_path'] }}" alt="poster" class="w-96" style="width:24rem">
            </div>
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold">{{ $tvShow['name'] }}</h2>
                <div class="flex items-center text-gray-400 text-sm">
                    <svg class="mt-1 fill-current text-orange-500 w-4" viewBox="0 0 24 24">
                        <g data-name="Layer 2">
                            <path
                    ...
                    <span class="mt-1 ml-1">{{ round($tvShow['vote_average'], 1) }}</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    @foreach ($tvShow['cast'] as $cast)
                        <div class="mt-8">
                            ...
                            <div class="mt-2">
                                <a href="{{ route('actors.show', $cast['id']) }}"
                                    class="text-lg hover:text-gray-300">{{ $cast['name'] }}</a>
    ...
    @if (count($tvShow['images']) > 0)
        <div class="tvShow-image border-b border-gray-800" x-data="{ isOpen: false, image: '' }">
            <div class="container mx-auto px-4 py-16">
                <h2 class="text-4xl font-semibold">Images</h2>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                    @foreach ($tvShow['images'] as $backdrop)
                        <div class="mt-8">
                            <a @click.prevent="
                                    isOpen=true
                                ...
                                "
                                href="#">
                                <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $backdrop['file_path'] }}" alt="backdrop"
